...
-- ?ãú???ä§ ?Éù?Ñ± : PK Î≤àÌò∏Î•? ?àú?Ñú??Î°? Ï£ºÍ≤å ?ïòÍ∏? ?úÑ?ï¥
...
user_id VARCHAR2(20) NOT NULL UNIQUE, -- ?ïÑ?ù¥?îî?äî Ï§ëÎ≥µ Î∂àÍ? 
...
user_authority VARCHAR2(20) DEFAULT 'generaluser' CHECK(user_authority IN ('admin', 'generaluser', 'reporter', 'suspended')) NOT NULL -- ?àò?†ï
)TABLESPACE users;
...
category_authority VARCHAR2(20) NOT NULL -- ?àò?†ï
)TABLESPACE users;
...
post_id NUMBER(10,0) NOT NULL, -- ?àò?†ï
category_id NUMBER(10,0) NOT NULL,
region_id NUMBER(10,0) NOT NULL,
user_num NUMBER(10,0) NOT NULL,
...
post_view NUMBER(10,0) DEFAULT 0 NOT NULL,  -- ?àò?†ï
post_like NUMBER(10,0) DEFAULT 0 NOT NULL, -- ?àò?†ï
post_reply NUMBER(10,0) DEFAULT 0 NOT NULL, -- ?àò?†ï
post_hide NUMBER(1,0) DEFAULT 0 CHECK(post_hide IN (0, 1)) NOT NULL , -- ?àò?†ï
...
user_num NUMBER(10,0) NOT NULL,
reply_group NUMBER(10,0) DEFAULT NULL, -- ?àò?†ï
post_id NUMBER(10,0) NOT NULL,
reply_content VARCHAR2(500) NOT NULL,
reply_regdate DATE DEFAULT sysdate,
reply_moddate DATE DEFAULT NULL,
reply_like NUMBER(5,0) DEFAULT 0 NOT NULL -- ?àò?†ï
)TABLESPACE users;
...
VALUES(1, '¿⁄¿Ø∞‘Ω√∆«', 'generaluser');

INSERT INTO rc_pro.category_info
VALUES(2, ' »´∫∏∞‘Ω√∆«', 'generaluser');
