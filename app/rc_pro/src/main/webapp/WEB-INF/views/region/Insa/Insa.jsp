	    ...
	    <div class="container-fluid d-flex align-items-center justify-content-between">
	      ...
	      <nav id="navbar" class="navbar">
	        <ul>	
	          ...
	          <li><a class="nav-link scrollto" href="/rc_pro/Insa/FreePost">자유 게시판</a></li>
	          <li><a class="nav-link scrollto" href="/rc_pro/Insa/PromotionPost">홍보 게시판</a></li>
	          <li><a class="nav-link scrollto" href="/rc_pro/Insa/NewsPost">뉴스</a></li>
	        </ul>
		  ...
		  <div>
		  	<sec:authorize access="isAuthenticated()">
			    <form id="logoutForm" role="form" action="${contextPath}/Insa" method="post">
	  		...
	  		<div id="free_post">
	  			...
	  			<table class="table table-striped table-bordered table-hover"
 					...
 					<c:forEach items="${freePostInfo}" var="FreePost">
 						<c:if test="${FreePost.post_hide == 0 and FreePost.region_id == 5}">
 							<tr>
	  		...
	  		<div id="promotion_post">
	  			<div id="page-wrapper">
 					...
 					<c:forEach items="${promtionPostInfo}" var="PromotionPost">
 						<c:if test="${PromotionPost.post_hide == 0 and PromotionPost.region_id == 5}">
 							<tr>
								<td style="text-align:left;">
									<a href="{대충 게시글로 간다는 내용}">
	  			...
	  			<table class="table table-striped table-bordered table-hover"
 					...
 					<tbody>
	 					<c:forEach items="${newsPostInfo}" var="NewsPost">
							<c:if test="${NewsPost.post_hide == 0 and NewsPost.region_id == 5}">
							    <tr>
							        <td style="text-align:left;">
							            <a href="{대충 게시글로 간다는 내용}">
